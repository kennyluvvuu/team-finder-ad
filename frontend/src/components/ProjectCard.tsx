...
export function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    <Card className="flex flex-col h-full overflow-hidden border bg-card hover:border-muted-foreground/30 hover:shadow-lg transition-all duration-300 group">
      ...
      <CardFooter className="p-5 pt-3 border-t bg-muted/10 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            ...
            className="inline-flex items-center gap-0.5 text-xs font-bold text-primary hover:underline transition-all"
          >
            Детали
